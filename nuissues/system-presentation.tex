...
The live application is hosted on Heroku\footnote{\url{https://heroku.com}}, which is a platform as a service for Node.js (and other) projects with a free option.
